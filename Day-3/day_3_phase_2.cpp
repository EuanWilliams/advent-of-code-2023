...
// int check_line(vector<GridCharacter> line, int character_index, bool inLine) {
//     // Check to left
...
//         if (character_to_check.part_of_number) {
//             return character_to_check.number_value;
//         }
//     }
...
//         GridCharacter character_to_check = line[character_index + 1];
//         // cout << "Checking right with char index " << character_index << " above: " << character_to_check.value << endl;
//         if (character_to_check.part_of_number) {
//             return character_to_check.number_value;
//         }
//     }
...
// int check_for_number_above_bellow(vector<vector<GridCharacter>> grid, int char_index, int line_index) {
//     int number_bellow;
//     int number_above;

//     number_above = check_line(grid[line_index - 1], char_index, true);
//     if (number_above == 0) {
//         cout << "   No number above" << endl;
//         return 0;
//     }

//     number_bellow = check_line(grid[line_index + 1], char_index, true);
//     if (number_bellow == 0) {
//         cout << "   No number bellow" << endl;
//         return 0;
//     }

//     cout << "   FOUND PAIR: " << number_above << " * " << number_bellow << " = " << number_above * number_bellow << endl;
//     return (number_above * number_bellow);
// }


// int check_for_number_to_left_or_right(vector<vector<GridCharacter>> grid, int char_index, int line_index) {
//     int number_left;
//     int number_right;
...
//         return 0;
//     }
//     else if ((char_index + 1) >= grid[line_index].size()) {
//         return 0;
//     } 

//     if (grid[line_index][char_index - 1].part_of_number && grid[line_index][char_index + 1].part_of_number) {
//         number_left = grid[line_index][char_index - 1].number_value;
//         number_right = grid[line_index][char_index + 1].number_value;
//     }

//     cout << "   FOUND PAIR: " << number_left << " * " << number_right << " = " << number_left * number_right << endl;
